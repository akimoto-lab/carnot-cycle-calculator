...
export const FireIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M12 22c-3.5 0-6-2.5-6-5.5s2.5-5.5 6-5.5 6 2.5 6 5.5-2.5 5.5-6 5.5Z" />
    <path d="M12 11.5A2.5 2.5 0 0 1 14.5 9a2.5 2.5 0 0 1 2.4-2.5 2.5 2.5 0 0 1 2.5-2.4 2.5 2.5 0 0 1 2.5-2.5" />
    <path d="M4 20c0-2 .5-3.5 2-5" />
  </svg>
);
